    ...
    def get_pics_info(self, pic_type) -> list:
        pic_info_list = [
            ...
            {'archival_num': '社保局-2019-0002',
             'faces': '[{"id": 1, "box": "[240, 60, 80, 80]", "name": "刘德华"}, '
                      '{"id": 2, "box": "[370, 80, 80, 80]", "name": "梅艳芳"}]',
             'img_path': os.path.abspath(r'.\qt\pic2.jpg'),
             'subject': '社保局主题2',
             'verifyState': 0},
            {'archival_num': '社保局-2019-0003',
             'faces': '[{"id": 1, "box": "[120, 60, 90, 100]", "name": "林志颖"}, '
                      '{"id": 2, "box": "[280, 100, 90, 100]", "name": "郭德纲"}]',
             'img_path': os.path.abspath(r'.\qt\pic3.jpg'),
             'subject': '社保局主题3',
             'verifyState': 0},
            {'archival_num': '社保局-2019-0004',
             'faces': '[{"id": 1, "box": "[90, 35, 120, 135]", "name": "杨幂"}, '
                      '{"id": 2, "box": "[280, 30, 120, 130]", "name": "迪丽热巴"}]',
