...
"padding-bottom: 8px;")
        ...
        self.gridLayout_26.addWidget(self.label_94, 1, 0, 1, 2)
...
"padding-bottom: 8px;")
        ...
        self.gridLayout_26.addWidget(self.searchface_select_photo_btn, 0, 3, 1, 1)
        ...
        self.gridLayout_26.addWidget(self.searchface_list_widget, 8, 0, 1, 7)
        ...
        self.gridLayout_26.addWidget(self.label_95, 6, 0, 1, 2)
        ...
        self.gridLayout_26.addWidget(self.label_96, 0, 0, 1, 2)
        ...
        self.gridLayout_26.addWidget(self.searchface_retieve_dir_line, 1, 2, 1, 1)

        self.lineEdit = QLineEdit(self.search_face_tab)
        self.lineEdit.setObjectName(u"lineEdit")
        self.lineEdit.setFont(font)

        self.gridLayout_26.addWidget(self.lineEdit, 0, 2, 1, 1)
...
"padding-bottom: 8px;")
        ...
        self.gridLayout_26.addWidget(self.searchface_select_retrieve_dir_btn, 1, 3, 1, 1)

        self.horizontalSpacer_25 = QSpacerItem(40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.gridLayout_26.addItem(self.horizontalSpacer_25, 0, 4, 1, 1)

        self.searchface_dst_show_view = QLabel(self.search_face_tab)
        ...
        self.gridLayout_26.addWidget(self.searchface_dst_show_view, 2, 3, 1, 4)
...
"padding-bottom: 8px;")
        ...
        self.gridLayout_26.addWidget(self.frame_6, 4, 0, 1, 5)

        self.searchface_src_view = QLabel(self.search_face_tab)
        ...
        self.gridLayout_26.addWidget(self.searchface_src_view, 2, 0, 1, 3)
...
"padding-bottom: 8px;")
        ...
        QWidget.setTabOrder(self.peoples_in_photo_arch, self.format_in_photo_search)
        ...
        QWidget.setTabOrder(self.peoples_in_photo_search, self.photo_num_in_group)
        QWidget.setTabOrder(self.photo_num_in_group, self.taken_locations_in_group)
        QWidget.setTabOrder(self.taken_locations_in_group, self.taken_time_in_group)
        QWidget.setTabOrder(self.taken_time_in_group, self.photographer_in_group)
        QWidget.setTabOrder(self.photographer_in_group, self.folder_size_in_group)
        QWidget.setTabOrder(self.folder_size_in_group, self.author_in_group)
        QWidget.setTabOrder(self.author_in_group, self.fonds_code_in_group)
        QWidget.setTabOrder(self.fonds_code_in_group, self.peoples_in_photo)
        QWidget.setTabOrder(self.peoples_in_photo, self.photographer_in_photo)
        ...
        QWidget.setTabOrder(self.photo_code_in_photo, self.fonds_name_in_setting)
        QWidget.setTabOrder(self.fonds_name_in_setting, self.fonds_code_in_setting)
        QWidget.setTabOrder(self.fonds_code_in_setting, self.all_photo_radioButton)
        QWidget.setTabOrder(self.all_photo_radioButton, self.group_caption_in_group)
        QWidget.setTabOrder(self.group_caption_in_group, self.part_recognition_radioButton)
        QWidget.setTabOrder(self.part_recognition_radioButton, self.group_code_in_photo)
        QWidget.setTabOrder(self.group_code_in_photo, self.all_recognition_radioButton)
        QWidget.setTabOrder(self.all_recognition_radioButton, self.group_code_in_group)
        QWidget.setTabOrder(self.group_code_in_group, self.retention_period_in_group)
        ...
        QWidget.setTabOrder(self.package_path_in_setting, self.arch_category_code_in_photo)
        QWidget.setTabOrder(self.arch_category_code_in_photo, self.thresh_lineEdit)
        QWidget.setTabOrder(self.thresh_lineEdit, self.department_in_group)
        QWidget.setTabOrder(self.department_in_group, self.arch_code_in_photo)
        QWidget.setTabOrder(self.arch_code_in_photo, self.verifycheckBox)
        QWidget.setTabOrder(self.verifycheckBox, self.current_dir_radioButton)
        QWidget.setTabOrder(self.current_dir_radioButton, self.arch_category_code_in_group)
        QWidget.setTabOrder(self.arch_category_code_in_group, self.description_path_in_setting)
        QWidget.setTabOrder(self.description_path_in_setting, self.order_combobox_transfer)
        ...
        QWidget.setTabOrder(self.selected_arch_list_widget, self.across_year_combo_box)
        QWidget.setTabOrder(self.across_year_combo_box, self.across_period_combo_box)
        QWidget.setTabOrder(self.across_period_combo_box, self.packeage_btn)
        QWidget.setTabOrder(self.packeage_btn, self.cd_size_line_edit)
        QWidget.setTabOrder(self.cd_size_line_edit, self.operation_date_in_transfer)
        QWidget.setTabOrder(self.operation_date_in_transfer, self.group_codes_in_transfer)
        QWidget.setTabOrder(self.group_codes_in_transfer, self.cd_catalog_table_widget)
        QWidget.setTabOrder(self.cd_catalog_table_widget, self.cd_num_in_transfer)
        QWidget.setTabOrder(self.cd_num_in_transfer, self.fonds_code_in_transfer)
        QWidget.setTabOrder(self.fonds_code_in_transfer, self.fonds_name_in_transfer)
        QWidget.setTabOrder(self.fonds_name_in_transfer, self.partition_list_widget)
        QWidget.setTabOrder(self.partition_list_widget, self.title_in_transfer)
        QWidget.setTabOrder(self.title_in_transfer, self.photo_num_in_transfer)
        QWidget.setTabOrder(self.photo_num_in_transfer, self.cd_model_in_transfer)
        QWidget.setTabOrder(self.cd_model_in_transfer, self.file_type_in_transfer)
        QWidget.setTabOrder(self.file_type_in_transfer, self.cd_type_in_transfer)
        QWidget.setTabOrder(self.cd_type_in_transfer, self.operator_in_transfer)
        QWidget.setTabOrder(self.operator_in_transfer, self.select_package_dir_btn)
        QWidget.setTabOrder(self.select_package_dir_btn, self.treeWidget)
        QWidget.setTabOrder(self.treeWidget, self.dir_lineEdit)
        QWidget.setTabOrder(self.dir_lineEdit, self.select_description_dir_btn)
        QWidget.setTabOrder(self.select_description_dir_btn, self.open_dir_btn)
        QWidget.setTabOrder(self.open_dir_btn, self.tabWidget)
        QWidget.setTabOrder(self.tabWidget, self.peoples_search)
        QWidget.setTabOrder(self.peoples_search, self.group_title_search)
        QWidget.setTabOrder(self.group_title_search, self.search_btn)
        QWidget.setTabOrder(self.search_btn, self.time_search)
        QWidget.setTabOrder(self.time_search, self.photographer_in_group_search)
        QWidget.setTabOrder(self.photographer_in_group_search, self.department_in_group_search)
        QWidget.setTabOrder(self.department_in_group_search, self.photo_num_in_group_search)
        QWidget.setTabOrder(self.photo_num_in_group_search, self.arch_code_in_photo_search)
        QWidget.setTabOrder(self.arch_code_in_photo_search, self.security_classification_in_group_search)
        QWidget.setTabOrder(self.security_classification_in_group_search, self.retention_period_in_group_search)
        QWidget.setTabOrder(self.retention_period_in_group_search, self.security_classification_in_group)
        QWidget.setTabOrder(self.security_classification_in_group, self.fonds_code_in_group_search)
        QWidget.setTabOrder(self.fonds_code_in_group_search, self.author_in_group_search)
        QWidget.setTabOrder(self.author_in_group_search, self.group_code_in_group_search)
        QWidget.setTabOrder(self.group_code_in_group_search, self.taken_locations_in_group_search)
        QWidget.setTabOrder(self.taken_locations_in_group_search, self.year_in_group_search)
        QWidget.setTabOrder(self.year_in_group_search, self.photo_code_in_photo_search)
        QWidget.setTabOrder(self.photo_code_in_photo_search, self.opening_state_in_group)
        QWidget.setTabOrder(self.opening_state_in_group, self.arch_code_in_group_search)
        QWidget.setTabOrder(self.arch_code_in_group_search, self.taken_time_in_group_search)
        QWidget.setTabOrder(self.taken_time_in_group_search, self.folder_size_in_group_search)
        QWidget.setTabOrder(self.folder_size_in_group_search, self.arch_category_code_in_group_search)
        QWidget.setTabOrder(self.arch_category_code_in_group_search, self.reference_code_in_group_search)
        QWidget.setTabOrder(self.reference_code_in_group_search, self.group_title_in_group_search)
        QWidget.setTabOrder(self.group_title_in_group_search, self.opening_state_in_group_search)
        QWidget.setTabOrder(self.opening_state_in_group_search, self.reference_code_in_group)
        QWidget.setTabOrder(self.reference_code_in_group, self.group_list_widget_search)
        QWidget.setTabOrder(self.group_list_widget_search, self.photo_list_widget_search)
        QWidget.setTabOrder(self.photo_list_widget_search, self.searchface_select_photo_btn)
        QWidget.setTabOrder(self.searchface_select_photo_btn, self.searchface_list_widget)
        QWidget.setTabOrder(self.searchface_list_widget, self.searchface_retieve_dir_line)
        QWidget.setTabOrder(self.searchface_retieve_dir_line, self.lineEdit)
        QWidget.setTabOrder(self.lineEdit, self.searchface_select_retrieve_dir_btn)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.treeWidget.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>\u53cc\u51fb\u52fe\u9009</p></body></html>", None))
